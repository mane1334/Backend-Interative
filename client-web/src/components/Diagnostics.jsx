...
export default function Diagnostics() {
  ...
  return (
    <div style={{fontSize:12, padding:6, background:'#ffffffcc', border:'1px solid #eee', borderRadius:6}}>
      <div style={{fontWeight:700}}>Diag</div>
      <div>API: {apiHealthy === null ? '...' : apiHealthy ? 'OK' : 'DOWN'}</div>
      <div>WS: {wsState}</div>
    </div>
  );
}

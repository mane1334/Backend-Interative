        ...
        <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 transform transition-all">
          ...
          <div className="rounded-2xl overflow-hidden">
            ...
            <div className="p-8">
              ...
              {/* Details Section (Prep Time & Calories) */}
              {(dish.preparation_time || dish.calories) && (
                <div className="flex gap-4 mb-6">
                  {dish.preparation_time && (
                    <div className="flex items-center gap-2 bg-red-50 text-red-700 px-3 py-1 rounded-full text-sm font-semibold">
                      <span role="img" aria-label="clock">⏰</span>
                      <span>{dish.preparation_time} min</span>
                    </div>
                  )}
                  {dish.calories && (
                    <div className="flex items-center gap-2 bg-orange-50 text-orange-700 px-3 py-1 rounded-full text-sm font-semibold">
